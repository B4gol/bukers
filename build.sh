...
chmod a+x ~/gcc64/bin/*
chmod a+x ~/gcc32/libexec/gcc/aarch64-elf/13.0.0/*
chmod a+x ~/gcc64/libexec/gcc/aarch64-elf/13.0.0/plugin/*
chmod a+x ~/gcc32/bin/*
chmod a+x ~/gcc32/libexec/gcc32/arm-eabi/13.0.0/*
chmod a+x ~/gcc32/libexec/gcc32/arm-eabi/13.0.0/plugin/*
